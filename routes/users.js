...
import { create, login, logout, extend, getProfile, getCart, editCart, addLike } from '../controllers/users.js'
...
router.post('/like', contentType('application/json'), auth.jwt, addLike)
